...
{
    //EndQuizPage ViewModel
    public class EndQuizPageViewModel : ViewModelBase
    {
        ...
        public EndQuizPageViewModel(INavigationService navigationService, IClientAPI clientAPI) : base(navigationService)
        {
            _navigationService = navigationService;
            _clientAPI = clientAPI;
            //CategoryClickCommand = new Command<object>(CategoryView);
            //CourseListCommand = new Command<object>(CourceView);
        ...
        public async void Back()
        {
            try
            {
                ...
                else
                {
                    ...
                    MessagingCenter.Send<object>(this, "RemoveBackStack");
